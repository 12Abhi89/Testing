...
public class lambdaTest {
	static String username = "abhishek%40tenxertech.com"; // Your username
    static String authkey = "u28c86633b7c6863"; 
    String testScore = "pass";
    ...
    public void setUp() throws Exception {
    	...
    	caps.setCapability("name", "Chrome 83x64");
        caps.setCapability("build", "SBCAutoTesting");
        
        caps.setCapability("browserName", "Chrome");
        caps.setCapability("version", "83x64");
	...
	public void configTest(String UserInputVoltage,String UserInputCurrent,String UserInputIrradiance ,String UserInputTemp) throws InterruptedException {
		...
		driver.findElement(ByAngular.buttonText("Login")).submit();
		//ngDriver.waitForAngularRequestsToFinish();
		
		//EVM Selecting page
		wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(ByAngular.repeater("form in Forms")));
	//	driver.findElement(ByAngular.repeater("form in Forms")).findElement().click();
		List<WebElement> EvmList=driver.findElements(ByAngular.repeater("form in Forms"));
		for(WebElement s:EvmList)
		{
			s.findElement(By.className("material-icons")).click();
			System.out.println("fghj");
		}
		//EvmList.get(0).findElement(By.className("material-icons")).click();
